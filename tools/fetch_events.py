...
from sources import base, npb, bigsight, dome, ariake, nntt, kabukiza, national_stadium, medical_society, nougakudo  # noqa: E402
...
def main():
    ...
    ap.add_argument("--sources", default="npb,bigsight,dome,ariake,nntt,kabukiza,national_stadium,medical_society,nougakudo", help="使うソース（カンマ区切り）")
