...
from sources import base, npb, bigsight, dome, ariake, nntt, kabukiza, national_stadium  # noqa: E402
...
def main():
    ...
    ap.add_argument("--sources", default="npb,bigsight,dome,ariake,nntt,kabukiza,national_stadium", help="使うソース（カンマ区切り）")
